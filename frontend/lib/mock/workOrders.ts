...
export const workOrders: WorkOrder[] = [
  ...
  {
    id: "wo-drn-1001",
    workOrderNumber: "WO-DRN-1001",
    projectId: null,
    workPackageId: null,
    aircraftId: "drn-kota-001",
    assetId: "drn-kota-001",
    title: "50-Hour Motor & ESC Electrical Diagnostic Check",
    ataChapter: "24",
    maintenanceType: "INSPECTION",
    priority: "MEDIUM",
    assignedTechnicianId: "tech-1",
    ...
    status: "IN_PROGRESS",
    requiredPartIds: [],
    requiredTools: ["Multimeter", "Motor Tachometer"],
    relatedRequirementId: "req-dgca-car-3x",
    relatedAssessmentId: "asmt-drn-001-1",
    checklistId: null,
    findingIds: [],
    signOff: null,
    inspectorReviewId: null,
  ...
  {
    id: "wo-drn-1002",
    workOrderNumber: "WO-DRN-1002",
    projectId: null,
    workPackageId: null,
    aircraftId: "drn-kota-003",
    assetId: "drn-kota-003",
    title: "100-Hour Airframe Structural Integrity & Arm Fastener Torque",
    ataChapter: "53",
    maintenanceType: "INSPECTION",
    priority: "HIGH",
    assignedTechnicianId: "tech-4",
    ...
    status: "WAITING_PARTS",
    requiredPartIds: ["part-1"],
    requiredTools: ["Torque Wrench (Micro-scale)"],
    relatedRequirementId: "req-insp-100h",
    relatedAssessmentId: "asmt-drn-003-1",
    checklistId: null,
    findingIds: ["fnd-drn-003-1"],
    signOff: null,
    inspectorReviewId: null,
  },
  {
    id: "wo-drn-1003",
    workOrderNumber: "WO-DRN-1003",
    projectId: null,
    workPackageId: null,
    aircraftId: "drn-kota-005",
    assetId: "drn-kota-005",
    title: "Propeller Blade #3 Stress Fracture Replacement",
    ataChapter: "61",
    maintenanceType: "REPLACEMENT",
    priority: "CRITICAL",
    assignedTechnicianId: "tech-1",
    ...
    status: "ASSIGNED",
    requiredPartIds: [],
    requiredTools: ["Prop Balancer"],
    relatedRequirementId: "req-dgca-car-3x",
    relatedAssessmentId: "asmt-drn-005-1",
    checklistId: null,
    findingIds: ["fnd-drn-005-1"],
    signOff: null,
    inspectorReviewId: null,
  },
];
