...
export const DEMO_PLATFORM_PLANS: PlanResponse[] = [
  {
    ...
    name: "Starter Commercial Fleet",
    code: "starter",
    description: "Foundational fleet management and compliance operations.",
    is_active: true,
  ...
  },
  {
    ...
    name: "Professional Autonomous Ops",
    code: "professional",
    description: "Expanded MRO tracking, drone missions, and automated inspections.",
    is_active: true,
    created_at: "2026-01-01T00:00:00Z",
    updated_at: "2026-01-01T00:00:00Z",
  },
  {
    ...
    name: "Enterprise Multi-Domain Control",
    code: "enterprise",
    description: "Unlimited fleet scaling, LISA AI copilot, and governance controls.",
    is_active: true,
    created_at: "2026-01-01T00:00:00Z",
    updated_at: "2026-01-01T00:00:00Z",
  },
  {
    ...
    name: "Legacy Standard Tier (V1)",
    code: "legacy_v1",
    description: "Archived plan for grandfathered tenants. No new subscriptions allowed.",
    is_active: false,
